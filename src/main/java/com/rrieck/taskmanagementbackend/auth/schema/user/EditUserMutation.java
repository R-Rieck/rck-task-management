...
import com.rrieck.taskmanagementbackend.auth.service.user.EditUserService;
...
public class EditUserMutation {
	...
	@MutationMapping
	public UserTypes.UserType editUser(@Argument UserTypes.EditUserInput input, Authentication authentication) {
